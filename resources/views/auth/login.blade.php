...
<head>
    ...
    <title>Bibit Sriwedari - Login</title>
            ...
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    ...
                    <form action="{{ route('login') }}" method="POST">
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="password" class="form-control form-control-xl @error('password') is-invalid @enderror" id="password" name="password" placeholder="Password" required autocomplete="current-password">
                            <div class="form-control-icon">
